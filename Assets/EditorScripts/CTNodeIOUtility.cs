...
namespace CT.Utilis
{
    public class CTNodeIOUtility : MonoBehaviour
    {
        ...
        [SerializeField] private CTDialogueSO next_node;

        [SerializeField] private string current_node_dlog;
        [SerializeField] private string current_node_tip;
        [SerializeField] private List<CTDialogueChoiceData> current_node_choices;
        ...
        public void OnOptionChosen(int _choice_index)
        {
            ...
            if (current_node.list_dlog_choices.Count > 0)
            {
                ...
                if (current_node.dlog_type == Enumerations.CTDialogueType.Narration)
                {
                    ...
                    next_node = current_node.list_dlog_choices[0].next_dlog_node;
                }
        ...
        public List<CTDialogueChoiceData> GetDlogChoices()
        {
