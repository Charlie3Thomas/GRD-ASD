...
namespace CT.ScriptableObjects
{
    public class CTDialogueSO : ScriptableObject
    {
        ...
        public void Initialise(string _dialogue_name, string _text, string _tip_text, List<CTDialogueChoiceData> _choices, CTDialogueType _dialogue_type, bool _is_starting_dialogue)
        {
